...
| **Is this idea tradeable?** | **Yes, but only above a specific capital threshold (~$100k+) and with selective sector targeting.** Gross of costs, it is statistically robust (26/30 names significant, not repackaged momentum). Net of costs, small accounts (<$30k-$40k) face total capital ruin from broker minimum ticket fees ($0.35/order eating 15-25+ bps), whereas accounts $\ge \$100\text{k}$ achieve **9.20% CAGR and 0.88 Sharpe** (beating SPY's 0.65 Sharpe at half volatility) as costs converge to ~1.2 bps against a 4.71 bps breakeven. |
