...
> **Out-of-sample validation:** every Sharpe ratio below (1.16 headline, 0.89-1.16 by window) is an in-sample, full-history number. [`walk_forward_validation.md`](walk_forward_validation.md) tests it on a genuine 2011-2026 holdout never touched during lookback selection: **Sharpe 0.53**, not 1.16. Still positive in every out-of-sample cut tested, but size expectations around the lower number, not this document's headline figure.
