...
| Paired t-test, overnight mean > intraday mean across tickers | t = 2.07, **p = 0.047** | — |
...
| Does it concentrate anywhere? | **Yes** — growth/high-attention sectors (Tech, Discretionary, Comm Services, Financials). It *reverses* in Staples, Energy, Utilities. |
